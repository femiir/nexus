...
// const EventAgenda = ({ agendaItems }: { agendaItems: unknown }) => {
//     let items: string[] = [];
    
//     if (Array.isArray(agendaItems)) {
//         // Check if first element is a stringified array
//         if (agendaItems.length === 1 && typeof agendaItems[0] === 'string') {
//             try {
//                 const parsed = JSON.parse(agendaItems[0]);
...
// const EventTags = ({ tags }: { tags: unknown }) => {
//     let tagItems: string[] = [];
...
//                 tagItems = Array.isArray(parsed) ? parsed : tags;
//             } catch {
//                 tagItems = tags;
//             }
//         } else {
            ...
            <div className="details">
                ...
                <div className="content">
                    ...
                    <section className="flex-col-gap-2">
                        ...
                        <EventDetailItem icon="/icons/calendar.svg" alt="calendar" label={new Date(date).toLocaleDateString('en-US', {
                            year: 'numeric',
                            month: 'long',
                            day: 'numeric'
                        })} />
                ...
                <div className="events">
                    {similarEvents.length > 0 && similarEvents.map((similarEvent) => (
                        <EventCard 
                            ...
                            date={new Date(similarEvent.date).toLocaleDateString('en-US', {
                                year: 'numeric',
                                month: 'short',
                                day: 'numeric'
                            })}
